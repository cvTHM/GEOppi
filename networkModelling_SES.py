...
netBHE = gp.read_file(r'Z:\02_Mitarbeiter\Constantin_Voelzel\THESA_THM\10_Promotionsvorhaben\20_Verschriftlichungen\03_SmartEnergySystemsConference_2025\04_GIS\Layer\network\BHE_v2\networkFeedReflux_dimensioned_manually_pipes.gpkg')

netWW = gp.read_file(r"Z:\02_Mitarbeiter\Constantin_Voelzel\THESA_THM\10_Promotionsvorhaben\20_Verschriftlichungen\03_SmartEnergySystemsConference_2025\04_GIS\Layer\network\Water_v2\networkFeedReflux_dimensioned_manually_pipes.gpkg")

net4GDH = gp.read_file(r"Z:\02_Mitarbeiter\Constantin_Voelzel\THESA_THM\10_Promotionsvorhaben\20_Verschriftlichungen\03_SmartEnergySystemsConference_2025\04_GIS\Layer\network\4GHD\networkFeedReflux_dimensioned_manually_pipes_new.gpkg")

fln_out = Path(r'C:\Users\const\Desktop\SES\networkModelling\networks_out.xlsx')

writer = pd.ExcelWriter(fln_out, engine='xlsxwriter')

netBHE.to_excel(writer, sheet_name = 'netBHE')
netWW.to_excel(writer, sheet_name = 'netWW')
net4GDH.to_excel(writer, sheet_name = 'net4GDH')
...
### Filepaths
# Input path
flp = Path(r'Z:\02_Mitarbeiter\Constantin_Voelzel\THESA_THM\10_Promotionsvorhaben\20_Verschriftlichungen\03_SmartEnergySystemsConference_2025\04_GIS\Layer')

# output path
flp_out = Path(r'C:\Users\const\Desktop\SES\networkModelling')
...
# Load pipes
pipes = gp.read_file(flp / Path('network_raw_BHE_v2.gpkg')).to_crs(cs)

# Load Buildings layer
buildings = gp.read_file(flp / Path('buildings_sms_BHE_v2.gpkg')).to_crs(cs)
...
producers = gp.read_file(flp / Path('producers_4GDH.gpkg')).to_crs(cs)
